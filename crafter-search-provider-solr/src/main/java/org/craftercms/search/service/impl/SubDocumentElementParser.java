...
public class SubDocumentElementParser implements ElementParser {
    ...
    public SubDocumentElementParser() {
        idFieldName = AbstractDocumentBuilder.DEFAULT_ID_FIELD_NAME;
        rootIdFieldName = AbstractDocumentBuilder.DEFAULT_ROOT_ID_FIELD_NAME;
        siteFieldName = AbstractDocumentBuilder.DEFAULT_SITE_FIELD_NAME;
        localIdFieldName = AbstractDocumentBuilder.DEFAULT_LOCAL_ID_FIELD_NAME;
        publishingDateFieldName = AbstractDocumentBuilder.DEFAULT_PUBLISHING_DATE_FIELD_NAME;
        publishingDateAltFieldName = AbstractDocumentBuilder.DEFAULT_PUBLISHING_DATE_ALT_FIELD_NAME;
