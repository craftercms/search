 ...
 * @author avasquez
 */
public class SolrDocumentBuilderImpl extends AbstractDocumentBuilder<SolrInputDocument> implements SolrDocumentBuilder {
    ...
    public SolrInputDocument build(String site, String finalId, String id, String xml,
        ...
        addFields(solrDoc, finalId, id, site, null);
    ...
    public SolrInputDocument build(String site, String finalId, String id, Map<String, List<String>> fields) {
        SolrInputDocument solrDoc = new SolrInputDocument();

        logger.debug("Building Solr doc for {}", finalId);

        addFields(solrDoc, finalId, id, site, fields);

        return solrDoc;
    }

    @Override
    protected void addFields(final SolrInputDocument solrDoc, final String finalId, final String id,
                             final String site, final Map<String, List<String>> fields) {
