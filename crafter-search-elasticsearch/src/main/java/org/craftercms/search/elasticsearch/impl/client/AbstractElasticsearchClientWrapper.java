...
package org.craftercms.search.elasticsearch.impl.client;
...
/**
 * Base implementation of {@link ElasticsearchClientWrapper}
 * @author joseross
 * @since 4.0.0
 */
public abstract class AbstractElasticsearchClientWrapper implements ElasticsearchClientWrapper {
    ...
    public AbstractElasticsearchClientWrapper(ElasticsearchClient client) {
        this.client = client;
    }
