...
/**
 * Unit tests for {@link ElasticsearchXmlFileBatchIndexer}.
 *
 * @author avasquez
 */
public class XmlFileBatchIndexerTest extends BatchIndexerTestBase {
    ...
    private ElasticsearchXmlFileBatchIndexer batchIndexer;
    ...
    public void testUpdateIndex() throws Exception {
        ...
        verify(searchService).index(indexId, SITE_NAME, UPDATE_FILENAME, EXPECTED_XML, null);
